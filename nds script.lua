...
local Paragraph = Tab:CreateParagraph({Title = "Note:", Content = "(?) - Client-Sided"})
local Label = Tab:CreateLabel("(i) - Will only work if someone on the server has a balloon")
local Tab = Window:CreateTab("Credits", 119971176) -- Title, Image
local Section = Tab:CreateSection("About script:")
local Paragraph = Tab:CreateParagraph({Title = "Made by churka", Content = "(sorry for the shitty code)"})